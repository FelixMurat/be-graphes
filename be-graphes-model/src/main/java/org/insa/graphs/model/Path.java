...
public class Path {
    ...
    public boolean isValid() {
    	boolean resu=true;
	        for(int i=0;i<(arcs.size()-1);i++) {
	        	if (i==0) {
	        		if (arcs.get(i).getOrigin()!=getOrigin()) {
	        			resu=false;
	        		}
	        	}
    ...
    public double getTravelTime(double speed) {
    	double resu=(((double)this.getLength())/(speed/3.6d));
        return resu;
    }
